...
const eventosDePruebaSinUsuarios = [
  // ─── 1. FLYERS REALES RESTAURADOS (ALINEACIÓN EXACTA DEL FLYER) ───────────
  {
  ...
  // ─── 2. EVENTOS NUEVOS DEDICADOS A LAS BANDAS ────────────────────────────
  {
    nombre: "Viva El Diavlo Tour",
    imagen: "https://images.unsplash.com/photo-1508854710579-5cecc3a9ff17?auto=format&fit=crop&w=1200&q=80",
    generos: ["Surf Punk", "Rock Crudo", "Psicodelia"],
    fecha: new Date("2026-10-03"),
    hora: "22:30",
    lugar: "Magic Music Box, San Lorenzo 353",
    descripcion: "Bogardus festeja dos décadas de rock crudo, surf punk y psicodelia tucumana. Presentan temas de Viva El Diavlo en Magic Music Box con Maleza abriendo el escenario.",
    precio: 3000,
    artistasBandas: [
  ...
  {
    nombre: "Presentación Oficial: Eustalgia",
    imagen: "https://images.unsplash.com/photo-1470229722913-7c0e2dbbafd3?auto=format&fit=crop&w=1200&q=80",
    generos: ["Dream Rock", "Synth Pop", "Alternativo"],
    fecha: new Date("2026-10-24"),
    hora: "21:00",
    lugar: "La Gesta Cultural, Congreso 177",
    descripcion: "Utópico Amanecer presenta en vivo su álbum debut Eustalgia. Una atmósfera envolvente de sintetizadores, nostalgia y euforia junto a Siesta de Agosto.",
    precio: 2800,
    artistasBandas: [
      { nombre: "Siesta de Agosto", username: "siestadeagosto" },
      { nombre: "Utópico Amanecer", username: "utopico.amanecer", headliner: true },
    ],
    capacidadTotal: 90,
    stock: 90,
  },
  {
    nombre: "Noche de Cepa Tucumana",
    imagen: "https://images.unsplash.com/photo-1516450360452-9312f5e86fc7?auto=format&fit=crop&w=1200&q=80",
    generos: ["Pop-Rock", "Rock Alternativo"],
    fecha: new Date("2026-11-14"),
    hora: "22:00",
    lugar: "El Piletón, Rondeau 478",
    descripcion: "Los tres hermanos de Mientras el Lobo encienden El Piletón con sus canciones directas y energía de rock alternativo tucumano. Costas abre la jornada.",
    precio: 2000,
    artistasBandas: [
      { nombre: "Costas", username: "costas" },
      { nombre: "Mientras el Lobo", username: "mientraselobo", headliner: true },
    ],
    capacidadTotal: 80,
    stock: 80,
  },
  {
    nombre: "Noche de Reggae & Ska",
    imagen: "https://images.unsplash.com/photo-1540039155733-5bb30b53aa14?auto=format&fit=crop&w=1200&q=80",
    generos: ["Reggae", "Ska", "Fusión"],
    fecha: new Date("2026-11-28"),
    hora: "20:30",
    lugar: "Casa de la Cultura de Tucumán, 25 de Mayo 73",
    descripcion: "Plutonio Jam desembarca con sus vientos y ritmo de reggae & ska para bailar en el patio de la Casa de la Cultura. Entrada libre con feria independiente y La Mugre abriendo.",
    precio: 0,
    artistasBandas: [
  ...
  {
    nombre: "London Avant-Garde Secret Show",
    imagen: "https://images.unsplash.com/photo-1511671782779-c97d3d27a1d4?auto=format&fit=crop&w=1200&q=80",
    generos: ["Math Rock", "Avant-Garde", "Experimental"],
    fecha: new Date("2026-12-18"),
    hora: "23:00",
    lugar: "Utopía Bar, Laprida 330",
    descripcion: "¡Easter Egg especial VOY Project! Cierre de año secreto con black midi directo desde Londres en Utopía Bar. Caos progresivo, math rock e improvisación sin límites. Abre Danny Proyectil.",
    precio: 6000,
    artistasBandas: [
      { nombre: "Danny Proyectil", username: "danny_proyectil" },
